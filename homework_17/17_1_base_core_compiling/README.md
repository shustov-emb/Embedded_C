...
Чтобы не рисковать основной системой, а дополнительной машины у меня нет, я установил **Ubuntu Server** на виртуальную машину. У этого решения оказалось два главных плюса:
* Снапшоты - позволяли мгновенно откатиться назад при ошибках сборки. Пользовался ими постоянно.
* Экономия ресурсов - отсутствие GUI сильно разгрузило оперативную память и процессор, что как мне казалось должно ускорить компиляцию ядра.
