...
/**
 * @brief Максимальная длина имени очереди клиента
 */
...
/**
 * @brief Имя общей очереди сервера
 */
#define SERVER_QUEUE "/13_3_Server"
...
typedef struct ChatMessage
{
    ...
    char client_queue[CHAT_QUEUE_SIZE];   /* Имя личной очереди клиента */
