# 16.1 AF_LOCAL/SOCK_STREAM

Написать две программы клиент/сервер, клиент подключается к серверу, отправляет сообщение, ждёт сообщения от сервера сеанс завершается! 
